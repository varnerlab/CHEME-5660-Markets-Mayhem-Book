...
Traders can initiate many types of orders. However, let’s consider only four basic classes of orders: a market order, a limit order, a stop order, and a cancel order.
